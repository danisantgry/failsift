import type { AnalysisReport, HistoryFailureGroup, HistoryReport, HistoryRunReference } from "./types.js";
...
export function buildHistoryReport(
  ...
  const grouped = new Map<string, HistoryFailureGroup>();
  const unclassifiedRuns: HistoryRunReference[] = [];
